#Survival model
#S9 - Intercept, Site, Year/age, Ht, Geno, Clim  
...
####### Setup design matrix
#X1 <- cbind(rep(1,N.surv),X.Sites.S,X.Yr.S,X.Ht.S,X.Geno.S,X.Sno.S) 
#X1 <- cbind(rep(1,N.surv),X.Sites.S,X.Yr.S,X.Ht.S,X.Geno.S,X.P.S) 
#X1 <- cbind(rep(1,N.surv),X.Sites.S,X.Yr.S,X.Ht.S,X.Geno.S,X.JMax.S)
#X1 <- cbind(rep(1,N.surv),X.Sites.S,X.Yr.S,X.Ht.S,X.Geno.S,X.JMin.S)
#X1 <- cbind(rep(1,N.surv),X.Sites.S,X.Yr.S,X.Ht.S,X.Geno.S,X.CWD.S) 

#X1 <- cbind(rep(1,N.surv),X.Sites.S,X.Yr.S,X.Ht.S,X.Geno.S2,X.Sno.S) 
#X1 <- cbind(rep(1,N.surv),X.Sites.S,X.Yr.S,X.Ht.S,X.Geno.S2,X.P.S)
#X1 <- cbind(rep(1,N.surv),X.Sites.S,X.Yr.S,X.Ht.S,X.Geno.S2,X.JMax.S)
#X1 <- cbind(rep(1,N.surv),X.Sites.S,X.Yr.S,X.Ht.S,X.Geno.S2,X.JMin.S)
X1 <- cbind(rep(1,N.surv),X.Sites.S,X.Yr.S,X.Ht.S,X.Geno.S2,X.CWD.S) 
...
par(mfrow=c(4,2))
  ...
  plot(seq(1,(ncyc+1)),bgibbs[13,],type='l')
   abline(h=Bpm[13],col='red')  
