#Survival model
#S3 - Intercept, Site, Year/age, Ht, ElevXSite 
...
X1 <- cbind(rep(1,N.surv),X.Sites.S,X.Yr.S,X.Ht.S,X.Site.Elev.S.2) 

I <- ncol(X1)  #columns of design matrix

###### Priors
Bpm <- c(2.5,rep(0,3),rep(-0.3,3),0.1,rep(0,16))
#Intercept = 0.92% survival; with years becomes 65%, 85%, 3 x 90%; with height, 10 cm +intercept+ 1st yr is 66.8%, 20 cm is 69%
#Bps <- c(3,rep(3,3),rep(3,3),3,rep(3,16))   #variances
Bps <- c(6,rep(6,3),rep(6,3),6,rep(6,16))   #variances
...
###Starting values
Beta <- c(runif(1,1,5),runif(3,-0.1,0.1),runif(3,-0.6,0.2),runif(1,-0.1,0.2),runif(16,-0.2,0.2))
...
par(mfrow=c(4,2))
  ...
  plot(seq(1,(ncyc+1)),bgibbs[20,],type='l')
   abline(h=Bpm[20],col='red')  
  plot(seq(1,(ncyc+1)),bgibbs[26,],type='l')
   abline(h=Bpm[26],col='red')   
...
rownames(outpar) <- c('Int','site17','site18','site19','Yr3','Yr4','Yr5','Ht','17_30','17_40','17_45','17_50','17_55','17_60','18_45','18_50','18_52','18_55','18_60','19_45','19_50','19_55','19_60','19_75','sig')
outpar
