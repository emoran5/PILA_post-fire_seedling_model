#Growth model
#G9 - Intercept, Site, Year/age, Ht, Geno, Clim
...
####### Setup design matrix
#X1 <- cbind(rep(1,N.grow),X.Sites.G,X.Yr.G,X.Ht.G,X.Geno.G,X.Sno.G) 
#X1 <- cbind(rep(1,N.grow),X.Sites.G,X.Yr.G,X.Ht.G,X.Geno.G,X.P.G) 
#X1 <- cbind(rep(1,N.grow),X.Sites.G,X.Yr.G,X.Ht.G,X.Geno.G,X.JMax.G) 
#X1 <- cbind(rep(1,N.grow),X.Sites.G,X.Yr.G,X.Ht.G,X.Geno.G,X.JMin.G) 
#X1 <- cbind(rep(1,N.grow),X.Sites.G,X.Yr.G,X.Ht.G,X.Geno.G,X.CWD.G) 

#X1 <- cbind(rep(1,N.grow),X.Sites.G,X.Yr.G,X.Ht.G,X.Geno.G2,X.Sno.G) 
#X1 <- cbind(rep(1,N.grow),X.Sites.G,X.Yr.G,X.Ht.G,X.Geno.G2,X.P.G) 
#X1 <- cbind(rep(1,N.grow),X.Sites.G,X.Yr.G,X.Ht.G,X.Geno.G2,X.JMax.G) 
#X1 <- cbind(rep(1,N.grow),X.Sites.G,X.Yr.G,X.Ht.G,X.Geno.G2,X.JMin.G) 
X1 <- cbind(rep(1,N.grow),X.Sites.G,X.Yr.G,X.Ht.G,X.Geno.G2,X.CWD.G) 
