#G model
#G7 - Intercept, Site, Year/age, Ht, SZxElev, Clim
...
####### Setup design matrix
#X1 <- cbind(rep(1,N.grow),X.Sites.G,X.Yr.G,X.Ht.G,X.SZ.Elev.G,X.Sno.G) 
#X1 <- cbind(rep(1,N.grow),X.Sites.G,X.Yr.G,X.Ht.G,X.SZ.Elev.G,X.P.G)  
#X1 <- cbind(rep(1,N.grow),X.Sites.G,X.Yr.G,X.Ht.G,X.SZ.Elev.G,X.JMax.G) 
#X1 <- cbind(rep(1,N.grow),X.Sites.G,X.Yr.G,X.Ht.G,X.SZ.Elev.G,X.JMin.G) 
X1 <- cbind(rep(1,N.grow),X.Sites.G,X.Yr.G,X.Ht.G,X.SZ.Elev.G,X.CWD.G) 


I <- ncol(X1)  #columns of design matrix

###### Priors
Bpm <- c(5,rep(0,3),rep(0,5),0.15,rep(0,16),0)
#Intercept = 5 cm annual growth; 0 site-level and year means; 
Bps <- c(6,rep(6,3),rep(6,5),6,rep(6,16),6)   #variances
...
###Starting values
Beta <- c(runif(1,2,10),runif(3,-2,2),runif(5,-2,2),runif(1,-0.1,0.5),runif(16,-2,2),runif(1,-1,1))
...
par(mfrow=c(4,2))
  ...
  plot(seq(1,(ncyc+1)),bgibbs[14,],type='l')
   abline(h=Bpm[14],col='red')  
  plot(seq(1,(ncyc+1)),bgibbs[18,],type='l')
   abline(h=Bpm[18],col='red')   
...
rownames(outpar) <- c('Int','site17','site18','site19','Yr1','Yr2','Yr3','Yr4','Yr5','Ht','526_45','526_50','526_52','526_55','531_30','531_40','531_45','531_50','531_55','531_60','532_50','532_55','532_60','533_60','540_60','997_75','Clim','sig')
outpar
